...
`count_product` INT NOT NULL  - если заказ создан, количество товара в заказе не может "не сущесвовать"
*/
...
NULL - означает что в ячейке таблицы отсутсвует какое либо значание . Буквально некакого значения не задано .
*/